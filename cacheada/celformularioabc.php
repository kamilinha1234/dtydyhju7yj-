    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($totalSimA > $totalSimB && $totalSimA > $totalSimC) {
            ...
            if ($totalSimA == $totalSimB && $totalSimB == $totalSimC) {
                echo '<p>' . $nome . ', você tem uma preferência equilibrada entre visual, auditiva e cinestésica.</p>';
                ...
                echo '<p>' . $nome . ', você tem uma preferência equilibrada entre visual e cinestésica.</p>';
            } elseif ($totalSimB == $totalSimC) {
                echo '<p>' . $nome . ', você tem uma preferência equilibrada entre auditiva e cinestésica.</p>';
            }
        }
        echo '</div>';
    }
